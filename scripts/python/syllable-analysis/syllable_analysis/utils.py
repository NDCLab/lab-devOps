...
def get_participants(base_dir: str, accepted_subjects: list[str] = None) -> list[str]:
    """
    ...
    Parameters:
        ...
        accepted_subjects (list[str], optional): A list of subject directories to filter by. Defaults to None (accept all subjects).
    ...
    return [
        ...
        if (accepted_subjects is None or s in accepted_subjects)
