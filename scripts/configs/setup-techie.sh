...
crontab -l | { cat; echo "30 14 * * * /home/data/NDClab/tools/lab-devOps/scripts/updates/check-hpc-status.sh > /home/data/NDClab/other/logs/cpu-history/"`date +"\\%m_\\%d_\\%Y::\\%H:\\%M:\\%S"`".log 2>&1"; } | crontab -
